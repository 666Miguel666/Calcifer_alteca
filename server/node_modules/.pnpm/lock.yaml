...
importers:
  ...
  .:
    dependencies:
      ...
      mysql2:
        specifier: ^3.23.0
        version: 3.23.0(@types/node@26.1.1)
    devDependencies:
      nodemon:
        specifier: ^3.1.14
        version: 3.1.14
...
packages:
  ...
  mysql2@3.23.0:
    resolution: {integrity: sha512-ZwyGLoG9BRlL7hKNDcIy7q18hA6WTWGEpLAerGHXj5Xahemia4msZdwjIOUIzesjK3B5z5gWLktf+2tYSLAyTA==}
    engines: {node: '>= 8.0'}
    peerDependencies:
      '@types/node': '>= 8'
...
snapshots:
  ...
  mysql2@3.23.0(@types/node@26.1.1):
    dependencies:
      '@types/node': 26.1.1
      aws-ssl-profiles: 1.1.2
      denque: 2.1.0
